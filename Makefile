...
# stakater.com/jira-service-desk-operator-bundle:$VERSION and stakater.com/jira-service-desk-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= stakater.com/jira-service-desk-operator
